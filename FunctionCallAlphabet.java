...
public static void main( String[] args )
	{
		...
		f("Frape");    // displays the word you pass it beginning with "F"
		...
		n("nar");    // displays the word you pass it beginning with "N"
		...
		t("tama");    // displays the word you pass it beginning with "T"
		System.out.print(u());    // returns the word to be displayed
		v(1);    // tell it how many times to display the word (1)
		w(1);    // pass it any integer and it will display a word beginning with W 
